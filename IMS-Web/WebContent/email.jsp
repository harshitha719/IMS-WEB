...
<body id="page-top">
	...
	<div
		style="padding-left: 500px; padding-top: 40px; align-self: center;">
		<%=(request.getAttribute("message") == null) ? ""
					: request.getAttribute("message") + " " + "to" + " " + request.getAttribute("senderEmail")%>
	</div>
	<div align="center" style="padding-top: 100px">
		<form id="sendMail" action="Controller" name="form" method="post">
			<div class="md-form">
				<input type="text" id="inputIconEx1" name="email"
					 placeholder="Enter Email Address" > <input
					type="submit" class="btn btn-dark" value="Send"
