	...
	<div id="wrapper">
		<div id="content-wrapper">
		  ...
		  request.setAttribute("inventoryList",inventoryList);
            ...
            <td><c:out value="${listItems.product}" /></td>
            <td><c:out value="${listItems.model}" /></td>
            <td><c:out value="${listItems.manufacturer}" /></td>
            <td><c:out value="${listItems.typeCode}" /></td>
            <td><c:out value="${listItems.locationCode}" /></td>
            <td><c:out value="${listItems.msrp}" /></td>
            <td><c:out value="${listItems.unitCost}" /></td>
            <td><c:out value="${listItems.discountRate}" /></td>
            <td><c:out value="${listItems.quantity}" /></td> </tr> 
    		</c:forEach> 
