	...
	public static void loadToFile() throws SQLException, IOException {
		...
		try {
			...
			while (rs.next()) {
			        ...
			        out.write(Double.toString(rs.getDouble(7)) .concat(Constants.recordDelimiter));
			        out.write(Double.toString(rs.getDouble(8)) .concat(Constants.recordDelimiter));
			        out.write(Double.toString(rs.getDouble(9)) .concat(Constants.recordDelimiter));
			        out.write(Double.toString(rs.getDouble(10)) .concat(Constants.recordDelimiter));
			        out.newLine();
			}
